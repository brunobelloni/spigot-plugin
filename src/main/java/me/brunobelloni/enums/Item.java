...
public class Item {
    ...
    public static ItemStack SWITCHER_ITEM = createItem(Material.SNOW_BALL, "&cSwitcher", new String[]{"", ""});
    public static ItemStack SWITCHER_CD = createItem(Material.SLIME_BALL, "&cSwitcher Cooldown", new String[]{"", ""});
